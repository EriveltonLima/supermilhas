...
(function attachMilhasCalculator(global) {
  ...
  global.MilhasCalculator = Object.freeze({
    isIberiaPeak, getLatamRegion, getLatamFixedEconomyValue, parseSeatsDate, getActiveCabin, getFlightProgram, getExploreNavBadges, getExploreBadgeKind, getExploreNavPriority, getExploreNavGroup, getAlternativePrograms, isDirectExploreTitle, isQatarFeaturedBusinessRoute, buildLatamSearchUrl, extractTripRoute, setCpms, parseQuantity, extractCashAmount, getLatamEstimate, findMentions, calculateCost, formatCurrency, formatFixedTableValue, annotateElement, annotateSeatsAero, annotateSeatsTripCards, annotateSeatsExplore, annotateSeatsExploreNav, annotateQatarFeaturedRoutes, annotateSeatSpy, annotateQatarAirways, annotateLatamAirlines, annotateGoogleFlights, annotateDocument, observeDocument
  });
}(globalThis));
